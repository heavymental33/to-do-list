...
init();
// function with a loop that load the localstorage data into the page when a user come back
...
// function to validate if the user has enter a valid value (*** À amméliorer ***)
...
function injectList(arr) {
    if(arr === planification) {
		var li = document.getElementById("list-planification");
